...
class UserRelationsControllerTest < ActionController::TestCase
  ...
  test "should create user_relation" do
    assert_difference('UserRelation.count') do
      post :create, user_relation: { enum: @user_relation.enum, relation_id: @user_relation.relation_id, user_id: @user_relation.user_id }
    end
  ...
  test "should update user_relation" do
    put :update, id: @user_relation, user_relation: { enum: @user_relation.enum, relation_id: @user_relation.relation_id, user_id: @user_relation.user_id }
    assert_redirected_to user_relation_path(assigns(:user_relation))
  end
